...
# ready - the bullet is still in the ship
...
score_value = 0
font = pygame.font.Font("IMAGES/JetBrainsMono-Medium.ttf", 32)
textX = 10
textY = 10

game_over = pygame.font.Font("IMAGES/JetBrainsMono-Medium.ttf", 64)
